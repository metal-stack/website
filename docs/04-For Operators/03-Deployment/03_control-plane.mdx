...
Before you try to deploy the control-plane, you should have had a look at the [architecture](../../05-Concepts/01-architecture.mdx) concepts section.
  ...
  metal-stack:
    ...
    steps:
      ...
      - run: |
          ...
          ansible-playbook deploy_metal_stack.yaml
        env:
...
See the [metal-images reference](https://metal-stack.io/docs/references/metal-images/#supported-images) for currently supported images.
