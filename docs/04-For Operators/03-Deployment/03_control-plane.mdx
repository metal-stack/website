...
The control plane deployment described here requires an initial Kubernetes cluster as bootstrap infrastructure, which is described in [Initial Cluster](./02_initial-cluster.md).
