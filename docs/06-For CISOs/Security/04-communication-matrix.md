...
| 2.1  | metal-apiserver        | Metal Control Plane  |   TCP    | valkey                 | Metal Control Plane  | 6379  |     |     |  x   |   x   | Background Jobs                | Used for background job processing and caching.  |
| 2.2  | metal-apiserver        | Metal Control Plane  |   TCP    | metal-db               | Metal Control Plane  | 28015 |  x  |  x  |  x   |   x   | RethinkDB                      | Database access.                                 |
| 2.3  | metal-apiserver        | Metal Control Plane  |   TCP    | tenant-apiserver       | Metal Control Plane  | 8080  |     |     |      |   x   | API Requests                   | Used for resource scoping access.                |
| 2.4  | metal-apiserver        | Metal Control Plane  |   HTTP   | ipam                   | Metal Control Plane  | 9090  |     |     |      |   x   | Address Management             | Used to manage IP addresses.                     |
| 2.5  | metal-apiserver        | Metal Control Plane  |   TCP    | auditing timescaledb   | Metal Control Plane  | 5432  |     |     |  x   |   x   | Audit Logs                     | Logging of auditing events. Used for compliance. |
| 2.6  | metal-apiserver        | Metal Control Plane  |  HTTPS   | headscale              | Metal Control Plane  | 50443 |  x  |  x  |  x   |   x   | Headscale API                  | Headscale is used for VPN networking.            |
| 2.7  | metal-apiserver        | Metal Control Plane  |  HTTPS   | OIDC Provider          | unknown              |  443  |  x  |  x  |  x   |   ?   | Authentication & Authorization | Optional. Needs to be configured.                |
| 3.1  | tenant-apiserver       | Metal Control Plane  |   TCP    | tenant-db              | Metal Control Plane  | 5432  |     |     |  x   |   x   | Postgres database access       | Database access.                                 |
| 4.1  | ipam                   | Metal Control Plane  |   TCP    | ipam-db                | Metal Control Plane  | 5432  |     |     |  x   |   x   | Postgres database access       | Database access.                                 |
| 5.1  | backup-restore-sidecar | Metal Control Plane  |  HTTPS   | S3-compatible Storage  | unknown              |  443  |  ?  |  ?  |  ?   |   ?   | Backup & Restore               | Optional. Needs to be configured.                |
| 5.2  | backup-restore-sidecar | Metal Control Plane  |  HTTPS   | Google API             | Internet             |  443  |  x  |  x  |  x   |       | Backup & Restore               | Optional. Needs to be configured.                |
| 5.3  | backup-restore-sidecar | Metal Control Plane  |   TCP    | Postgres               | Metal Control Plane  | 5432  |     |     |  x   |   x   | Backup & Restore               | Optional. Needs to be configured.                |
| 5.4  | backup-restore-sidecar | Metal Control Plane  |   TCP    | RethinkDB              | Metal Control Plane  | 28015 |     |     |  x   |   x   | Backup & Restore               | Optional. Needs to be configured.                |
| 5.5  | backup-restore-sidecar | Metal Control Plane  |   TCP    | ETCD                   | Metal Control Plane  | 2380  |     |     |  x   |   x   | Backup & Restore               | Optional. Needs to be configured.                |
| 5.6  | backup-restore-sidecar | Metal Control Plane  |   TCP    | Redis                  | Metal Control Plane  | 6379  |     |     |  x   |   x   | Backup & Restore               | Optional. Needs to be configured.                |
| 5.7  | backup-restore-sidecar | Metal Control Plane  |   TCP    | keydb                  | Metal Control Plane  | 6379  |     |     |  x   |   x   | Backup & Restore               | Optional. Needs to be configured.                |
| 6.1  | metal-console          | Partition Management |   HTTP   | metal-apiserver        | Metal Control Plane  | 8080  |     |     |  x   |   x   | API Requests                   | Used for management operations.                  |
| 6.2  | metal-console          | Partition Management |  HTTPS   | metal-bmc              | Partition Management | 3333  |  x  |  x  |  x   |   x   | Machine Management             | Used for management operations.                  |
| 7.1  | ssh                    | unknown              |   TCP    | metal-console          | Partition Management | 10001 |  x  |  x  |  x   |   ?   | Machine Access (SSH)           | Used to access the metal-console via SSH.        |
| 8.1  | pixiecore              | Partition Management |  HTTPS   | metal-apiserver        | Metal Control Plane  |  443  |  x  |  x  |  x   |   x   | API Requests                   | Used for management operations.                  |
| 9.1  | metal-bmc              | Partition Management |  HTTPS   | metal-apiserver        | Metal Control Plane  |  443  |  x  |  x  |  x   |   x   | API Requests                   | Used for management operations.                  |
| 9.2  | metal-bmc              | Partition Management |   TLS    | nsq                    | Partition Management | 4150  |  x  |  x  |  x   |   x   | Machine Operation              | Used for machine operations and notifications.   |
| 9.2  | metal-bmc              | Partition Management |   IPMI   | machine BMC            | Machine              |  623  |     |     |  x   |   x   | Machine Operation              | Used for BMC management.                         |
| 10.1 | metal-cache-image-sync | Partition Management |  HTTPS   | S3-compatible Storage  | unknown              |  443  |  ?  |  ?  |  ?   |       | Image Caching and Sync         | Optional. Needs to be configured.                |
| 10.2 | metal-cache-image-sync | Partition Management |  HTTPS   | metal-apiserver        | Metal Control Plane  |  443  |  x  |  x  |  x   |       | API Requests                   | Used for management operations.                  |
| 11.1 | metal-hammer           | Machine              |  HTTPS   | metal-apiserver        | Metal Control Plane  |  443  |  x  |  x  |  x   |   x   | API Requests                   | Used for management operations.                  |
| 11.2 | metal-hammer           | Machine              |  HTTPS   | pixiecore              | Partition Management |  443  |  x  |  x  |      |   x   | Machine Management             | Used for machine management.                     |
| 11.3 | metal-hammer           | Machine              |  HTTPS   | Prometheus             | unknown              |  443  |  x  |  x  |  x   |   x   | Monitoring                     | Actively pushes metrics to Prometheus.           |
| 11.4 | metal-hammer           | Machine              |   HTTP   | HAProxy                | Metal Control Plane  | 9001  |     |  x  |      |   x   | Image Caching and Pulling      | Used to pull images via HAProxy.                 |
| 11.5 | metal-hammer           | Machine              |  HTTPS   | Container Registry     | internet             |  443  |  x  |  x  |  ?   |       | Image and Pulling              | Used to pull images from the registry.           |
| 12.1 | machine firmware       | Machine              |  HTTPS   | pixiecore              | Partition Management |  443  |  x  |  x  |      |   x   | Machine Management             | Used to provision machines with iPXE.            |
| 12.2 | machine firmware       | Machine              |   TFTP   | pixiecore              | Partition Management |  69   |     |     |      |   x   | Machine OS Provisioning        | Used to provision machine firmware.              |
| 13.1 | machine OS             | Machine              |   DHCP   | DHCP Server            | Machine              | 67/68 |     |     |      |   x   | Machine OS Provisioning        | Used to obtain an IP address.                    |
| 13.2 | machine OS             | Machine              |   DNS    | DNS Server             | Machine              |  53   |     |     |      |   x   | Machine OS Resolution          | Used to resolve hostnames.                       |
| 13.3 | machine OS             | Machine              |   NTP    | NTP Server             | Machine              |  123  |     |     |      |   x   | Machine OS Time Sync           | Used to synchronize time with the NTP server.    |
| 14.1 | metal-metrics-exporter | Metal Control Plane  |  HTTPS   | metal-apiserver        | Metal Control Plane  |  443  |  x  |  x  |  x   |   x   | Monitoring                     | Scrapes metrics from metal-apiserver.            |
| 15.1 | prometheus             | Metal Control Plane  |  HTTPS   | metal-apiserver        | Metal Control Plane  |  443  |  x  |  x  |  x   |   x   | Monitoring                     | Scrapes metrics from metal-apiserver.            |
| 15.2 | prometheus             | Metal Control Plane  |  HTTPS   | metal-metrics-exporter | Metal Control Plane  | 9080  |     |     |      |   x   | Monitoring                     | Scrapes metrics from metal-metrics-exporter.     |
| 15.4 | prometheus             | Metal Control Plane  |  HTTPS   | tenant-apiserver       | Metal Control Plane  | 2113  |  x  |  x  |  x   |   x   | Monitoring                     | Scrapes metrics from tenant-apiserver.           |
...
| No.  | Component  | Source Zone       | Protocol | Destination          | Destination Zone    | Port  |  C  |  I  | Auth | Trust | Purpose       | Notes                                         |
| ---- | ---------- | ----------------- | :------: | -------------------- | ------------------- | :---: | :-: | :-: | :--: | :---: | ------------- | --------------------------------------------- |
| S1.1 | metal-core | Leaf Switches     |  HTTPS   | metal-apiserver      | Metal Control Plane |  443  |  x  |  x  |  x   |   x   | API Requests  | Used for management operations.               |
...
| No.  | Component                                 | Source Zone  | Protocol | Destination     | Destination Zone    | Port |  C  |  I  | Auth | Trust | Purpose      | Notes                                       |
| ---- | ----------------------------------------- | ------------ | :------: | --------------- | ------------------- | :--: | :-: | :-: | :--: | :---: | ------------ | ------------------------------------------- |
| G1.1 | metal-ccm                                 | Seed Cluster |  HTTPS   | metal-apiserver | Metal Control Plane | 443  |  x  |  x  |  x   |   x   | API Requests | Used for management operations.             |
| G1.2 | metal-ccm                                 | Seed Cluster |  HTTPS   | kube-apiserver  | Shoot Cluster       | 443  |  x  |  x  |  x   |   x   | API Requests | Used for management operations.             |
| G2.1 | firewall-controller-manager               | Seed Cluster |  HTTPS   | metal-apiserver | Metal Control Plane | 443  |  x  |  x  |  x   |   x   | API Requests | Used for firewall management.               |
...
| G4.1 | machine-controller-manager-provider-metal | Seed Cluster |  HTTPS   | metal-apiserver | Metal Control Plane | 443  |  x  |  x  |  x   |       | API Requests | Used for management operations.             |
| G5.1 | gardener-extension-provider-metal         | Seed Cluster |  HTTPS   | metal-apiserver | Metal Control Plane | 443  |  x  |  x  |  x   |       | API Requests | Used for management operations.             |
...
| No.  | Component                        | Source Zone        | Protocol | Destination     | Destination Zone    | Port |  C  |  I  | Auth | Trust | Purpose      | Notes                           |
| ---- | -------------------------------- | ------------------ | :------: | --------------- | ------------------- | :--: | :-: | :-: | :--: | :---: | ------------ | ------------------------------- |
| C1.1 | metal-ccm                        | Workload Cluster   |  HTTPS   | metal-apiserver | Metal Control Plane | 443  |  x  |  x  |  x   |       | API Requests | Used for management operations. |
...
| C2.1 | cluster-api-provider-metal-stack | Management Cluster |  HTTPS   | metal-apiserver | Metal Control Plane | 443  |  x  |  x  |  x   |       | API Requests | Used for management operations. |
