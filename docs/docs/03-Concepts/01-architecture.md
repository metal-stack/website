...
:::info
How large you can grow your partitions and how the network topology inside a partition looks like is described in the [networking](../05-For%20CISOs/network.md) document.
:::
...
- This figure is slightly simplified. The switch plane consists of spine switches, exit routers, management firewalls and a bastion router with more software components deployed on these entities. Please refer to the [networking](../05-For%20CISOs/network.md) document to see the full overview over the switch plane.
