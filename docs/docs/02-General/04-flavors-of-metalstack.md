...
Using plain metal-stack without additional layer was not a focus in the past. Therefore firewall and role management might be premature. These will be addressed by [MEP-4](../../community/04-Proposals/MEP4/README.md) and [MEP-16](../../community/04-Proposals/MEP16/README.md) in the future.
