...
Fine-grained access control with full multi-tenancy support is actively worked on in [MEP4](/community/MEP-4-multi-tenancy-for-the-metal-api).
...
Only the minimum role required to access the group of endpoints is shown. For the more in-depth documentation of all endpoints, head over to the [API documentation](../08-References/Control%20Plane/metal-api/metal-api.md).
